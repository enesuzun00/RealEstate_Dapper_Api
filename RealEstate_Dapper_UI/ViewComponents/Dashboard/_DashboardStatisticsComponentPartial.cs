...
namespace RealEstate_Dapper_UI.ViewComponents.Dashboard
{
    public class _DashboardStatisticsComponentPartial:ViewComponent
    {
        ...
        public async Task<IViewComponentResult>InvokeAsync()
        {
            ...
            var responseMessage1 = await client1.GetAsync("https://localhost:44344/api/Statistics/ProductCount");
            ...
            var responseMessage2 = await client2.GetAsync("https://localhost:44344/api/Statistics/EmployeeNameByMaxProductCount");
            ...
            var responseMessage3 = await client3.GetAsync("https://localhost:44344/api/Statistics/DifferentCityCount");
